...
import com.nibiru.tlsproxy.R.id.*
import com.nibiru.tlsproxy.ui.FragmentActionCenter
import com.nibiru.tlsproxy.ui.FragmentApMode
import com.nibiru.tlsproxy.ui.FragmentNetwork
import com.nibiru.tlsproxy.proxy.ProxyService
...
class MainActivity : AppCompatActivity(), ServiceConnection,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val evilAPServiceIntent = Intent(this, AppService::class.java)
    ...
    override fun onServiceConnected(name: ComponentName?, service: IBinder?) {
        if (service is AppService.LocalBinder) {mService = service.service}
