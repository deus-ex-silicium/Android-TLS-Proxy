...
class FragmentNetwork: android.support.v4.app.Fragment(){
    ...
    private var mHostList: ArrayList<AppService.Host> = ArrayList()
    ...
    private fun setupEventBus(){
        ...
        disposable = RxEventBus.INSTANCE.getFrontEndObservable().subscribe {
            ...
            when(it) {
                ...
                is AppService.EventScannedHosts -> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mHostList = savedInstanceState.getSerializable("mHostList") as ArrayList<AppService.Host>
    }
...
//        }
    ...
    private fun doScan(){
        ...
        mHostList.clear()
        RxEventBus.INSTANCE.send2BackEnd(AppService.EventActiveScan("ARP"))
    }
